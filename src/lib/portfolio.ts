...
export const portfolio: PortfolioItem[] = [
  ...
  },
  {
    ...
    numeral: 'iii.',
    name: 'SeaBreeze Landscape Care and Home Repair',
    category: 'site',
    ...
    image: {
      ...
      alt: 'SeaBreeze Landscape Care and Home Repair, Bandon Oregon: coastal logo in cream and teal on a deep green field.',
      width: 1200,
      height: 630,
    },
    details: [
    ...
    details: [
      {
        ...
        value:
          'The symbol, the lettering beside it, and the palette it has to survive in. It comes with a build when a company needs one, and it stands alone when the rest is already doing its job.',
      },
      {
        label: 'Where it runs',
        value:
